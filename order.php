...
/*
  ...
  try {
    ...
    //    var_dump("<pre>",$results[0]->get("image")); exit;
  ...
  foreach ($subCategories as $key => $value) {
        ...
        foreach ($myStoresIds as $key => $v) {
            ...
            if($myresult){
                // echo "<pre>";
                // print_r($myresult->category);die;
                $currentCat = '';
                $cI = 1;
                foreach ($myresult->category as $cCat) {
                    $currentCat .= 
                    ($cI != count($myresult->category)) ?$cCat .   ', ':$cCat; 
                    $cI++;
                }
                
                $previewData[$i] .= '
                <div>
                <a href="detail.php?Id='.$myresult->getObjectId().'">
                    <div class="card">
                        <div class="inside">
                            <div class="icon">
...
$homeBannerQuery = new ParseQuery("HomeBanner");
try{
    $homeBanners = $homeBannerQuery->find();
}catch(ParseException $ex){
    echo $ex->getMessage();
}
...
$bannerHtml = '';
$bannerHtmlImageOnly = '';
foreach($homeBanners as $bannerKey =>$banner){
       $bannerImage =  $banner->get("bannerImg");
            ...
            <div class="col-12">
                <div class="jumbotron header-banner p-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <img src="'.$bannerImage->getURL().'" class="img-responsive img-container img-fluied">
                    </div>
                </div>
            </div>
        </div>';
    ...
    <div class="card">
        ...
        <div class="card-body px-0 py-2">
            <div class="d-flex justify-content-between align-items-center md-2">
                ...
                <div class="d-flex  justify-content-evenly align-items-center">
                    <p class="deal-price mb-0 mx-2">'.$storeRating.'</p><img class="img-container img-fluid" src="static/images/icons/star.svg"
                        class="star-2">
                </div>
            </div>
            <div class="d-block d-md-flex justify-content-between">
                <p class="deal-cat-2 mb-0">'.$categoryItem.'</p>
...
<body>
    ...
    <div class="container my-4">
                        ...
                        <!-- <div class="col-12">
                            <div class="jumbotron header-banner p-0">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <img src="static/images/image 24.png" class="img-responsive">
                                </div>
                            </div>
                        </div> -->
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-10 menu_right_sec">
                ...
                <section class="popular">
                    ...
                    <div id="popular-owl-carousel_<?=$i; ?>" class="owl-carousel">
                        ...
                        <?= ($types[$subcat->title])?$types[$subcat->title]:"<span>No Record Found</span>" ?>
                        <!-- endFor -->
                                        ...
                                        <div class="card mt-4">
                                            ...
                                            <div class="card-body p-2">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <div class="d-flex  justify-content-evenly">
                                                        <!-- Add Dynamic Product Rating here -->
                                                        <p class="deal-price mb-0 mx-2">4.9 </p><i><img
