...
try {
    ...
    foreach ($results as $result){
        ...
        foreach ($menuResult as $key => $value) {
            ...
            $mymenuresult[$a]["dishImage"] = $value->get('image');

            $mymenuresult[$a]["dishImageurl"] = ($value->get('image') != null) ? $value->get('image')->getURL() : '';
            //https://parsefiles.back4app.com/gg2zjiKqqH9hpSXWVSoXv8ZG6aJ1CA9ImhTO0bEd/ffd34653efced509c2df5f0e2241b909_bg-1.jpg
                            ...
                            $menuItem .='<div class="col-md-6">
                                            ...
                                            <a data-toggle="modal" id="'.$ItemId.'" data-distitle="'.ucwords($allItem["dishTitle"]).'" data-dishdescription="'.nl2br($allItem["dishDescription"]).'" data-itemImg="'.$imageURL.'" data-target="#myModal_'.$ItemId.'" class="showMymodal" data-catobj="'. $categoryObject.'" data-cattitle="'.$categoryTitle.'" data-storeid="'.$storeId.'" data-storename="'.$storeName.'" data-price="'.$allItem['price'].'">
                                                ...
                                                <div class="row featured-place-wrap menu_item_box" style="margin-top:50px;">   
                                                    ...
                                                    <div class="'.$desClass.' item_box_left" style="padding:0px;">
                                                        ...
                                                        <div class="featured-title-box">
                                                            ...
                                                            <p class="menu_item_desc">'.nl2br($allItem["dishDescription"]).'</p>
                                                    ...
                                                    ';
                                        if($imageURL!=''):
                                        $menuItem .=  '<div class="col-md-4 featured-responsive item_box_image" style="padding:0px; margin:0px;">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
            ...
            $(document).on("click",".showMymodal",function(){
                ...
                let title = $(this).data("distitle");

                let description = $(this).data("dishdescription");

                let img = $(this).data("itemimg");

                let catobj = $(this).data("catobj");

                let cattitle = $(this).data("cattitle");
                ...
                $(".sauchitem").html(`<div class="d-flex justify-content-center pt-5"><div class="loader"></div></div>`);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        const {sauchitem,addtocart} = JSON.parse(response);
