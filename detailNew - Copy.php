...
try {
    ...
    foreach ($results as $result){
        $manicatagory["object_id"] = $result->getObjectId();
        $manicatagory["title"] = $result->get("itemTitle");
    }

    // print_r($manicatagory);die;
    ...
    // $storeName = $mystoredata ["storeName"];
    // $address = $mystoredata ["address"];
    // $storeImageUrl = $mystoredata ["storeImageUrl"];
    // $openingHours = $mystoredata ["openingHours"];
    // $phoneNumber = $mystoredata ["phoneNumber"];
    // $emailAddress = $mystoredata ["emailAddress"];
    // $coordinate = $mystoredata ["coordinate"];
    // $storeDescription = $mystoredata ["storeDescription"];
    // $website = $mystoredata ["website"];
    // $priceRate = $mystoredata ["priceRate"];
    // $headline = $mystoredata ["headline"];
    // $reviewsCount = $mystoredata ["reviewsCount"];
    // $authorImage = $mystoredata ["authorImage"];
    // $authorCountry = $mystoredata ["authorCountry"];
    // $amenities = $mystoredata ["amenities"];
    // $authorName = $mystoredata ["authorName"];
    // $storeRating = $mystoredata ["storeRating"];
            ...
            <div class="col-md-12 menu_list_holder">
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper ">
                        ...
                        ?>
                        <a href="#<?php echo $maincategoryObjectId ?>" class="swiper-slide"
                           style=""><?php echo $maincategoryTitle ?></a>
                        <?php endforeach; ?>
            ...
            <div class="col-md-12 responsive-wrap px-0">
                ...
                <?php foreach ($results as $result):
                    ...
                    try {
                        ...
                        $menuItem .= '
                            <div class="col-md-6">
                                <a data-toggle="modal" data-target="#myModal_'.$ItemId.'"  >
                                    <div class="row featured-place-wrap menu_item_box" style="margin-top:50px;">   
                                        <div class="col-md-8 item_box_left" style="padding:0px;">
                                            <div class="featured-title-box">
                                                ...
                                                <p class="menu_price">$'.$allItem->get('price').'</p>
